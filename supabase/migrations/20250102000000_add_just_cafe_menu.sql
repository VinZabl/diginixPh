...
INSERT INTO site_settings (id, value, type, description) VALUES
  ('site_name', 'Diginix', 'text', 'The name of the site'),
  ('site_logo', '/logo.png', 'image', 'The logo image URL for the site'),
  ('site_description', 'Welcome to Diginix — Your perfect game credits destination', 'text', 'Short description of the site'),
...
UPDATE site_settings SET value = 'Diginix' WHERE id = 'site_name';
UPDATE site_settings SET value = 'Welcome to Diginix — Your perfect game credits destination' WHERE id = 'site_description';
